...
return [
    ...
    'timeline' => [
        ...
        'navigate' => [
            ...
            'today' => 'Hoje',
            'next' => 'Próximo',
            'timeline' => 'Voltar para a linha do tempo',
        ],
    ],
    'list' => [
        'headers' => [
    ...
    'form' => [
        ...
        'published_at_helper' => 'Agende o incidente para aparecer na página de status em uma data futura. Fica oculto para todos até lá. Deixe em branco para publicar imediatamente.',
