...
return [
    ...
    'form' => [
        ...
        'availability_section_title' => 'Disponibilidade',
        'enabled_label' => 'Ativo',
        'checked_label' => 'Monitoramento',
        'checked_helper' => 'Verifique este componente periodicamente e registre sua disponibilidade.',
    ],
    'status' => [
