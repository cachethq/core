...
<div x-data x-disclosure {{ $attributes
    ...
    <div class="flex items-center justify-between bg-white p-4 dark:border-zinc-700 dark:bg-[var(--background)]">
    ...
    <div x-disclosure:panel x-collapse class="flex flex-col divide-y bg-white dark:bg-[var(--background)]">
